...
import com.example.lovepetrescue.databinding.MakeProfileBinding
...
class MakeProfileFragment : Fragment(), AdapterView.OnItemSelectedListener {
    ...
    override fun onCreateView(
        ...
        val adapt = ArrayAdapter(this.requireContext(), android.R.layout.simple_spinner_item, petTypes)
